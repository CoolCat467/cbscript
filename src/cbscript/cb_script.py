...
from cbscript import global_context, mcworld, tellraw
from cbscript.CompileError import CompileError
from cbscript.environment import environment
from cbscript.mcfunction import compile_section, mcfunction
...
class cbscript:
	...
	def add_temp_objectives(self):
		...
		for t in range(self.global_context.temp):
			f.insert_command(f'scoreboard objectives add temp{t!s} dummy', 0)
